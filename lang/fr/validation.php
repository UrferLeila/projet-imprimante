...
return [
    ...
    | la classe validator. Certaines de ces règles ont plusieurs versions comme
    ...
    */
    ...
    'doesnt_end_with' => 'Le champ :attribute ne doit pas finir par l\'un des éléments suivants : :values.',
